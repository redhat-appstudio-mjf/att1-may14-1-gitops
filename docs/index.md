...
# Application
An application built from https://github.com/redhat-appstudio-mjf/att1-may14-1 will be stored in [quay.io/maysunfaisal/att1-may14-1](https://quay.io/maysunfaisal/att1-may14-1) and deployed through GitOps. This application is accessible on port **8501**.